...
var submission = function() {
  ...
  // }
   ...
   if (year < 0) {
      ...
      output.innerHTML = name + " please enter a valid year! "
  }
    
  else if ((month < 1) || (month > 31)) {
      output.style.background ="black"
      output.style.color= "white"
      output.innerHTML = name + " please enter a valid month! "
  }
    
   else if (day < 0 || day > 31) {
      output.style.background ="black"
      output.style.color= "white"
      output.innerHTML = name + " please enter a valid day! "
  }
  ...
  //  }
    ...
    if(male.checked && year > 0 && month > 0 && month < 12 && day > 0 && day < 32) {
      output.style.background ="white"
        output.innerHTML = name + " you were born on a " + daysOfTheWeek[results] + " and your Akan name is " + maleNames[results];
    }
